...
foreach(OS ${EXECUTORCH_SUPPORTED_PLATFORM_OS})
  if(${EXECUTORCH_PLATFORM_TARGET_OS} STREQUAL ${OS})
    set(is_platform_target_os_${OS} ON)
  else()
    set(is_platform_target_os_${OS} OFF)
  endif()

  if(${EXECUTORCH_PLATFORM_HOST_OS} STREQUAL ${OS})
    set(is_platform_host_os_${OS} ON)
  else()
    set(is_platform_host_os_${OS} OFF)
  endif()
endforeach()

if(is_platform_target_os_macos OR is_platform_target_os_ios OR is_platform_target_os_ios_simulator)
  set(is_platform_target_os_apple ON)
else()
  set(is_platform_target_os_apple OFF)
endif()

# MARK: - Platform specific configuration

if(is_platform_target_os_apple)
  macro(_set_deployment_target platform_name deployment_target)
    set(PLATFORM ${platform_name} CACHE INTERNAL "Apple target platform")
    set(DEPLOYMENT_TARGET ${deployment_target} CACHE INTERNAL "Apple minimum deployment target")
  endmacro()

  if(is_platform_target_os_macos)
    _set_deployment_target("MAC_ARM64" "10.15")
  elseif(is_platform_target_os_ios)
    _set_deployment_target("OS64" "17.0")
  elseif(is_platform_target_os_ios_simulator)
    _set_deployment_target("SIMULATORARM64" "17.0")
  endif()

  announce_configured_options(PLATFORM)
  announce_configured_options(DEPLOYMENT_TARGET)
endif()
